...
class RegisterContacts extends StatefulWidget {
  String tokens;
  RegisterContacts({this.tokens});
  @override
  _RegisterContactsState createState() => _RegisterContactsState(tokens);
}

class _RegisterContactsState extends State<RegisterContacts> {
  String tokens;
  _RegisterContactsState(this.tokens);
  List contacts =
              ...
              ? IconButton(
                  ...
                  onPressed: () async {
                    ...
                    await Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                DisplayRegisteredContacts(testList2, tokens)));
